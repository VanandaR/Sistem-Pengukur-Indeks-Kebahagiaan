    ...
    <div class="md-card" id="login_card">
        <div class="md-card-content large-padding" id="register_form">
            ...
            <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="uk-form-row<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                    <label for="register_username">Username</label>
                    <input id="name" type="text" class="md-input <?php echo e($errors->has('name') ? 'md-input-danger' : ''); ?>" name="name" value="<?php echo e(old('name')); ?>" required autofocus>
                ...
                <div class="uk-form-row<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                    ...
                    <input id="email" type="email" class="md-input <?php echo e($errors->has('email') ? 'md-input-danger' : ''); ?>" name="email" value="<?php echo e(old('email')); ?>" required>
                ...
                <div class="uk-form-row<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                    ...
                    <input id="password" type="password" class="md-input <?php echo e($errors->has('password') ? 'md-input-danger' : ''); ?>" name="password" required>
