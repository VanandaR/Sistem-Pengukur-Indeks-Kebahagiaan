                            ...
                            <div class="md-card md-card-hover md-card-overlay">
                                <div class="md-card-toolbar">
                                    <h3 class="md-card-toolbar-heading-text">
                                        @
                                        <?php echo e($result->user->screen_name); ?>
                                ...
                                <div class="md-card-overlay-content">
                                    ...
                                    <form method="POST" action="/ahlibahasaclassification">
                                        ...
                                        <?php  $date = new DateTime($result->created_at);  ?>
                                        <input type="hidden" value="<?php echo e($result->user->screen_name); ?>" name="username">
                                        <input type="hidden" value="<?php echo e($result->text); ?>" name="tweet">
                                        <input type="hidden" value="<?php echo e($date->format("Y-m-d h:m:s")); ?>" name="post_time">
