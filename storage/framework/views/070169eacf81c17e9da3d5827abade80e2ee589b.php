<?php $__env->startSection('judul','Data Training Manual'); ?>
<?php $__env->startSection('konten'); ?>
    <div id="page_content">
        <div id="page_content_inner">
            <h4 class="heading_a uk-margin-bottom">Data Training Manual</h4>
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-large-1-1">
                    <div class="md-card">
                        <div class="md-card-content">
                            <h4 class="heading_c uk-margin-bottom">Distribusi Sentimen</h4>
                        ...
                        <?php $__currentLoopData = $datatraining; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="uk-modal" id="modal_edit_stopword<?php echo e($dt->id); ?>">
                                <div class="uk-modal-dialog">
                                    ...
                                    <form method="post" action="/datatraining/manual/label">
