        ...
        <div class="md-card-content large-padding" id="register_form">
            ...
            <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                ...
                <div class="uk-form-row{{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <input id="name" type="text" class="md-input {{$errors->has('name') ? 'md-input-danger' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
                    @if ($errors->has('name'))
                ...
                <div class="uk-form-row{{ $errors->has('email') ? ' has-error' : '' }}">
                    ...
                    <input id="email" type="email" class="md-input {{$errors->has('email') ? 'md-input-danger' : '' }}" name="email" value="{{ old('email') }}" required>
                    @if ($errors->has('email'))
                        <span class="help-block wrong_reason">
                                        {{ $errors->first('email') }}
                                    </span>
