            ...
            <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    <table id="dt_individual_search" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                        @php $i=0; @endphp
                        @foreach($tweethariini as $tweet)

                            <tr>
                                <td>{{$tweet->text}}</td>
                                <td>{{$klasifikasisentimen['hasil'][$i]}}</td>
                                @php $i++;@endphp
                            </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="md-card uk-margin-medium-bottom">
                <div class="md-card-content">
                    <form action="/streaming/save" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" value="{{$indekskebahagiaan['hasil']}}" name="indekskebahagiaan">
                    ...
                    <table class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Tweet Positif</td>
                                <td>{{$indekskebahagiaan['positif']}}</td>

                            </tr>
                            <tr>
                                <td>Tweet Negatif</td>
                                <td>{{$indekskebahagiaan['negatif']}}</td>

                            </tr>
                            <tr>
                                <td>Indeks kebahagiaan hari ini :</td>
                                <td>{{$indekskebahagiaan['hasil']}}</td>
